...
- :material-multimedia: __[MediaPortal]__ – transforms your PC into a complete media solution.
- :material-toy-brick-plus: __[Mediaportal Plugins]__ – A repository that contains Plugins and Skins for Mediaportal.
- :material-spider-web: __[MPExtended]__ – Project that aims at providing access to MediaPortal from all over the world.

</div>

  [MediaPortal]: https://github.com/MediaPortal/MediaPortal-1
  [Mediaportal Plugins]: https://github.com/Mediaportal-Plugin-Team
  [MPExtended]: https://github.com/MPExtended
